...
proto.relay.notification.v1.CreateWebhookConfigurationResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    notificationConfigurationId: (f = msg.getNotificationConfigurationId()) && google_protobuf_wrappers_pb.StringValue.toObject(includeInstance, f),
...
/**
 * optional google.protobuf.StringValue notification_configuration_id = 1;
 ...
 * @return {!proto.relay.notification.v1.CreateWebhookConfigurationResponse} returns this
 */
proto.relay.notification.v1.CreateWebhookConfigurationResponse.prototype.clearNotificationConfigurationId = function() {
  return this.setNotificationConfigurationId(undefined);
};
 ...
 * @return {boolean}
 */
proto.relay.notification.v1.CreateWebhookConfigurationResponse.prototype.hasNotificationConfigurationId = function() {

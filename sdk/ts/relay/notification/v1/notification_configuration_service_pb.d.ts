...
export class CreateWebhookConfigurationResponse extends jspb.Message {
  hasNotificationConfigurationId(): boolean;
  clearNotificationConfigurationId(): void;
  getNotificationConfigurationId(): google_protobuf_wrappers_pb.StringValue | undefined;
  setNotificationConfigurationId(value?: google_protobuf_wrappers_pb.StringValue): void;
...
export namespace CreateWebhookConfigurationResponse {
  export type AsObject = {
    notificationConfigurationId?: google_protobuf_wrappers_pb.StringValue.AsObject,
